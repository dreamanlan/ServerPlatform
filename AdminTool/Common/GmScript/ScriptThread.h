...
private:
  void HandleNameHandleChanged(bool addOrUpdate, const char* name, int handle)
  {
    if (NULL != m_pInterpreter && NULL != m_pCallbackObj){
      ...
      Value retVal;
      m_pInterpreter->CallMember(*m_pCallbackObj, Value("onNameHandleChanged"), FALSE, CallData::PARAM_CLASS_PARENTHESIS, params, 3, &retVal);
    }
  }
  void HandleMessage(unsigned int seq, int src, int dest, const char* data, int len)
  {
    if (NULL != m_pInterpreter && NULL != m_pCallbackObj){
      ...
      Value retVal;
      m_pInterpreter->CallMember(*m_pCallbackObj, Value("onMessage"), FALSE, CallData::PARAM_CLASS_PARENTHESIS, params, 4, &retVal);
    }
  }
  void HandleMessageResult(unsigned int seq, int src, int dest, bool result)
  {
    if (NULL != m_pInterpreter && NULL != m_pCallbackObj){
      ...
      Value retVal;
      m_pInterpreter->CallMember(*m_pCallbackObj, Value("onMessageResult"), FALSE, CallData::PARAM_CLASS_PARENTHESIS, params, 4, &retVal);
    }
  }
  void HandleCommand(int src, int dest, const char* result)
  {
    if (NULL != m_pInterpreter && NULL != m_pCallbackObj){
      ...
      Value retVal;
      m_pInterpreter->CallMember(*m_pCallbackObj, Value("onCommand"), FALSE, CallData::PARAM_CLASS_PARENTHESIS, params, 3, &retVal);
    }
  }
private:
  void Init(void)
