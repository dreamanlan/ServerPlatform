...
SlkToken::SlkToken(ScriptableData::IScriptSource& source, ScriptableData::ErrorAndStringBuffer& errorAndStringBuffer) :mSource(&source), mErrorAndStringBuffer(&errorAndStringBuffer)
{
  CrashAssert(mSource);
