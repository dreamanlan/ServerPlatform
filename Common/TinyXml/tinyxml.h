...
public:
    ...
    /// Visit a document.
    virtual bool VisitEnter(const TiXmlDocument& doc) { doc; return true; }
    /// Visit a document.
    virtual bool VisitExit(const TiXmlDocument& doc) { doc; return true; }

    /// Visit an element.
    virtual bool VisitEnter(const TiXmlElement& element, const TiXmlAttribute* firstAttribute) { element, firstAttribute; return true; }
    /// Visit an element.
    virtual bool VisitExit(const TiXmlElement& element) { element; return true; }

    /// Visit a declaration
    virtual bool Visit(const TiXmlDeclaration& declaration) { declaration; return true; }
    /// Visit a text node
    virtual bool Visit(const TiXmlText& text) { text; return true; }
    /// Visit a comment node
    virtual bool Visit(const TiXmlComment& comment) { comment; return true; }
    /// Visit an unknow node
    virtual bool Visit(const TiXmlUnknown& unknown) { unknown; return true; }
};
...
public:
    ...
    */
    ...
    void SetNameValue(const char* _name) { name = _name; }				///< Set the name of this attribute.
