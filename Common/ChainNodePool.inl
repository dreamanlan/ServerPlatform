...
template<typename DataT, typename RecyclerT, typename LockT, int SizeV>
void CChainNodePoolT<DataT, RecyclerT, LockT, SizeV>::Cleanup()
{
    m_UnusedDataNodes.Clear();
}

template<typename DataT, typename RecyclerT, typename LockT, int SizeV>
const typename CChainNodePoolT<DataT, RecyclerT, LockT, SizeV>::Iterator CChainNodePoolT<DataT, RecyclerT, LockT, SizeV>::NewNode()
{
    AutoLockT<LockT> lock(m_Lock);
