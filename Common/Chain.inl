...
inline void CChainNode<DataT, RecyclerT>::Recycle()
{
    m_Recycler.Recycle();
}

template<typename DataT, typename RecyclerT>
inline int CChainNode<DataT, RecyclerT>::IsAllocated() const
{
    return m_Recycler.IsAllocated();
}

template<typename DataT, typename RecyclerT>
inline void CChainNode<DataT, RecyclerT>::DisConnect()
{
    if (m_pChain) {
        --(m_pChain->m_uNum);
...
template<typename DataT, typename RecyclerT>
inline int CChain<DataT, RecyclerT>::AddFirst(const typename CChain<DataT, RecyclerT>::Iterator& it)
{
...
template<typename DataT, typename RecyclerT>
inline int CChain<DataT, RecyclerT>::AddLast(const typename CChain<DataT, RecyclerT>::Iterator& it)
{
    ItemType* pItem = it.GetPtr();
    if (NULL == pItem)
        return FALSE;
...
template<typename DataT, typename RecyclerT>
inline int CChain<DataT, RecyclerT>::InsertBefore(const typename CChain<DataT, RecyclerT>::Iterator& pos, const typename CChain<DataT, RecyclerT>::Iterator& it)
{
...
template<typename DataT, typename RecyclerT>
inline int CChain<DataT, RecyclerT>::InsertAfter(const typename CChain<DataT, RecyclerT>::Iterator& pos, const typename CChain<DataT, RecyclerT>::Iterator& it)
{
    ItemType* pItem1 = pos.GetPtr();
    ItemType* pItem2 = it.GetPtr();
    if (NULL == pItem1)
...
template<typename DataT, typename RecyclerT>
inline const typename CChain<DataT, RecyclerT>::Iterator CChain<DataT, RecyclerT>::RemoveFirst()
{
    if (GetNum() <= 0)
        return Iterator();
    return Remove(First());
...
template<typename DataT, typename RecyclerT>
inline const typename CChain<DataT, RecyclerT>::Iterator CChain<DataT, RecyclerT>::RemoveLast()
{
    if (GetNum() <= 0)
        return Iterator();
    Remove(Last());
...
template<typename DataT, typename RecyclerT>
inline int CChain<DataT, RecyclerT>::RemoveAll()
{
    Iterator it = First();
    for (; FALSE == it.IsNull();) {
        it = Remove(it);
