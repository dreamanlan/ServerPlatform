...
public:
    ...
    const StringMapObj& GetStringMap() const { return m_StrMapObj; }
    StringMapObj& GetStringMap() { return m_StrMapObj; }
    MyLock& GetLock() { return m_Lock; }
public:
