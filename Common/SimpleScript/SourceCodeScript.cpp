...
inline void ActionForGenerator::initialize_table(void)
{
    ...
    Action[14] = &ActionForGenerator::markPeriod;
    Action[15] = &ActionForGenerator::markQuestion;
    Action[16] = &ActionForGenerator::markQuestionParenthesisParam;
    Action[17] = &ActionForGenerator::markQuestionBracketParam;
    Action[18] = &ActionForGenerator::markQuestionBraceParam;
    Action[19] = &ActionForGenerator::markPointer;
    Action[20] = &ActionForGenerator::markStatement;
    Action[21] = &ActionForGenerator::markExternScript;
    Action[22] = &ActionForGenerator::setExternScript;
